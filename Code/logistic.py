...
kc_data = pd.DataFrame(df, columns=["Time","V1","V2","V3","V4","V5","V6","V7","V8","V9","V10","V11","V12","V13","V14","V15","V16","V17","V18","V19","V20","V21","V22","V23","V24","V25","V26","V27","V28","Amount","Class"])
label_col = 'Class'
print(kc_data.describe())


kc_x_train, kc_x_valid, kc_y_train, kc_y_valid = train_test_split(kc_data.iloc[:,0:13], kc_data.iloc[:,30],
...
history = model.fit(arr_x_train, arr_y_train,
    ...
    validation_data=(arr_x_valid, arr_y_valid),callbacks=[keras.callbacks.TensorBoard(log_dir="logs/final2", histogram_freq=1, write_graph=True, write_images=True)])
